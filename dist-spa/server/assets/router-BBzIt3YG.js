...
const appCss = "/achat-ou-location-simulation/assets/styles-LNXjFJlJ.css";
...
const $$splitComponentImporter$1 = () => import("./scpi-DUpSCdyI.js");
const Route$1 = createFileRoute("/scpi")({
  head: () => ({
    meta: [{
      title: "Simulateur SCPI — investissement à crédit ou comptant"
    }, {
      name: "description",
      content: "Simulez un investissement en SCPI, à crédit ou comptant, et comparez le rendement, le cashflow et le patrimoine sur 25 ans."
    }, {
      property: "og:title",
      content: "Simulateur SCPI — à crédit ou comptant"
    }, {
...
const $$splitComponentImporter = () => import("./index-5_37Zj0J.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Acheter ou louer ? Le simulateur"
    }, {
      property: "og:description",
      content: "Simulateur dynamique pour comparer achat vs location en France."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ScpiRoute = Route$1.update({
  id: "/scpi",
  path: "/scpi",
...
const getRouter = () => {
  const basepath = "/achat-ou-location-simulation";
