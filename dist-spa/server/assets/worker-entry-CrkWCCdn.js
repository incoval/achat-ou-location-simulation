...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-XgD4aeSh.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BBzIt3YG.js").then((n2) => n2.a),
...
var ROUTER_BASEPATH = "achat-ou-location-simulation";
var SERVER_FN_BASE = "/achat-ou-location-simulation/_serverFn/";
